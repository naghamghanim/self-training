...
def sequence_labeling_test(loader, model, classifier, label_list,with_segs, error_analysis = False):
    ...
    with torch.no_grad():
        ...
        for i in range(len(dataset)):
            tinput_ids, tattention_mask, labels_train, segments, segments_mask, segments_indices_mask = iter_test.next()
...
if __name__ == "__main__":
    ...
    if args.task_name == "ner":
        test_datasets =  ['data/NER/Darwish-MSA', 'data/NER/Darwish-DA']
    ...
    for run in range(5):
        ...
        for i in range(num_iterations):
            ...
            tinput_ids, tattention_mask, labels_train, t_segments, t_segments_mask, t_segments_indices_mask = iter_train.next()
            ...
            if not args.indomain:
                uinput_ids, uattention_mask, ulabels_train, u_segments, u_segments_mask, u_segments_indices_mask = iter_unlab.next()
