...
if __name__ == "__main__":
    ...
    if args.do_train:
        ...
        df.to_csv(f"/content/self-training/embeddings/train_examples_{config['domain']}.csv", index=False, encoding="utf-8-sig")
    ...
    df = pd.DataFrame(rows)
    df.to_csv(f"/content/self-training/embeddings/train_features_{config['domain']}.csv", index=False, encoding="utf-8-sig")
    ...
    if args.self_training:
            ...
            df = pd.DataFrame(rows)
            df.to_csv(f"/content/self-training/embeddings/self_training_examples_{config['domain']}.csv", index=False, encoding="utf-8-sig")
            ...
            df = pd.DataFrame(rows)
            df.to_csv(f"/content/self-training/embeddings/self_training_features_{config['domain']}.csv", index=False, encoding="utf-8-sig")
    ...
    for run in range(5):
        ...
        df = pd.DataFrame(rows)
        df.to_csv(f"/content/self-training/embeddings/selected_features_{config['domain']}_dann-run{run}.csv", index=False, encoding="utf-8-sig")
        ...
        df = pd.DataFrame(rows)
        df.to_csv(f"/content/self-training/embeddings/not_selected_features_{config['domain']}_dann-run{run}.csv", index=False, encoding="utf-8-sig")
