...
from utils.data_utils import SequenceLabelingProcessor, create_ner_dataset, SequenceClassificationProcessor, create_clf_dataset, load_data
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_msg', type=str, default='Nothing',
    help=" for log")
    ...
    if args.task_name == "pos":
        test_datasets =  ['data/POS-tagging/msa']
